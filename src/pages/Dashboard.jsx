...
<div className="grid md:grid-cols-4 gap-6 mb-10">
  ...
  rounded-3xl p-6 border border-zinc-800 hover:border-red-500 
  ...
  {/* CARD 3 */}
  <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 
  rounded-3xl p-6 border border-zinc-800 hover:border-yellow-500 
  transition-all duration-300 hover:scale-105">
  ...
  {/* CARD 4 */}
  <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 
  rounded-3xl p-6 border border-zinc-800 hover:border-green-500 
  transition-all duration-300 hover:scale-105">
...
<div className="grid md:grid-cols-2 gap-6">
  ...
  {scanResult?.vulnerabilities?.map((vuln, index) => (
    ...
    >
      ...
      <button
        className={`mt-5 px-5 py-2 rounded-xl font-bold
        ${
          vuln.severity === "Critical"
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              ...
              <tr className="border-b border-zinc-800">
                ...
                <td className="py-4">SecureAgent-AI</td>
              ...
              <tr className="border-b border-zinc-800">
                ...
                <td className="py-4">Banking-App</td>
              ...
              <tr>
                ...
                <td className="py-4">Portfolio-Website</td>
