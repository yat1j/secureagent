...
const mockData = {
  ...
  attack_path: {
    nodes: [
  { id: "vuln-1", file: "login.php",  vuln: "SQL Injection",        severity: "critical" },
  { id: "vuln-2", file: "search.php", vuln: "XSS",                  severity: "critical" },
  { id: "vuln-4", file: "admin.php",  vuln: "Broken Access Control", severity: "high"     },
  { id: "vuln-3", file: "config.py",  vuln: "Hardcoded Secret",      severity: "critical" },
],
    edges: [
  ...
  heatmap: [
  { file: "login.php",    risk_score: 95, vuln_count: 1, line_count: 120 },
  { file: "config.py",    risk_score: 90, vuln_count: 1, line_count: 40  },
  { file: "search.php",   risk_score: 80, vuln_count: 1, line_count: 85  },
  { file: "admin.php",    risk_score: 75, vuln_count: 1, line_count: 60  },
  { file: "download.php", risk_score: 70, vuln_count: 1, line_count: 75  },
  { file: "session.php",  risk_score: 60, vuln_count: 1, line_count: 95  },
  { file: "transfer.php", risk_score: 55, vuln_count: 1, line_count: 70  },
  { file: "index.php",    risk_score: 10, vuln_count: 0, line_count: 200 },
  { file: "utils.php",    risk_score:  5, vuln_count: 0, line_count: 150 },
],
};
